...
class BiplaneRegistration(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "BiplaneRegistration" # TODO make this more human readable by adding spaces
...
class BiplaneRegistrationWidget(ScriptedLoadableModuleWidget):
...
class BiplaneRegistrationLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imageThreshold, enableScreenshots=0):
    ...
    if enableScreenshots:
      self.takeScreenshot('BiplaneRegistrationTest-Start','MyScreenshot',-1)
